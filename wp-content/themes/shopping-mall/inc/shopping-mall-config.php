<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Theme Options', 'shopping-mall' ),
        'page_title'           => __( 'Shopping Mall Options', 'shopping-mall' ),
        ...
        'page_slug'            => 'shopping_mall_options',
    ...
    $args['admin_bar_links'][] = array(
        'id'    => 'shopping-mall-docs',
        'href'  => 'https://docs.ahiho.com/web/wordpress/themes/shopping-mall',
        'title' => __( 'Documentation', 'shopping-mall' ),
    );

    $args['admin_bar_links'][] = array(
        //'id'    => 'redux-support',
        'href'  => 'https://ahiho.com',
        'title' => __( 'Support', 'shopping-mall' ),
    );

    // SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    $args['share_icons'][] = array(
        'url'   => 'https://www.facebook.com/ahiho.jsc',
        'title' => 'Like us on Facebook',
        'icon'  => 'el el-facebook'
    );
    $args['share_icons'][] = array(
        'url'   => 'https://twitter.com/AhihoJSC',
