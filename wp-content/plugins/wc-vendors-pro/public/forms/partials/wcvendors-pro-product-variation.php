	...
	<div class="wcv-cols-group wcv_variation_inner"> 
		<div class="all-100"> 
			<h5 class="variation_title">
				<span class="wcv-sort"><i class="fa fa-sort"></i></span>
				...
				<div class="all-50 sku"> 
					<?php if ( wc_product_sku_enabled() ) : ?>
						<div class="control-group"> 
							<label><?php _e( 'SKU', 'wcvendors-pro' ); ?>: <?php //echo wc_help_tip( __( 'Enter a SKU for this variation or leave blank to use the parent product SKU.', 'wcvendors-pro' ) ); ?></label>
							<div class="control"> 
