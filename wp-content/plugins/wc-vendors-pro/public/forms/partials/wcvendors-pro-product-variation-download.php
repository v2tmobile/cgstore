<tr>
	...
	<td class="file_url">
		<div class="control"> 
			...
			<input type="hidden" class="file_id" name="_wc_variation_file_ids[<?php echo $variation_id; ?>][]" value="<?php echo esc_attr( $file['id'] ); ?>" />
			<input type="text" class="file_display" placeholder="<?php esc_attr_e( "http://", 'wcvendors-pro' ); ?>" name="_wc_variation_file_display[<?php echo $variation_id; ?>][]" value="<?php echo esc_attr( $file['file_display'] ); ?>" />
		</div>
	</td>
